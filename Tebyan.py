...
*   **لتفعيل خاصية سحب وإفلات الملفات**: يجب تثبيت مكتبة `tkinterdnd2` عن طريق الأمر: `pip install tkinterdnd2`
"""
COPY_TEXT = "نسخ"
PASTE_TEXT = "لصق"
CUT_TEXT = "قص"
...
def file_processing_worker(file_list, output_dir, progress_queue, text_transformation_func):
    ...
    for input_path in file_list:
        ...
        try:
            ...
            safe_name = name.replace(" ", "_") # Basic sanitization
